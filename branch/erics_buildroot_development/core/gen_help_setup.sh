...
__register_config_option 'Kernel Configuration' 'kbuild-output-clean' 'false' 'true' 'Clean Kbuild output directory.'
profile_set_key kbuild-output-clean false 'system'
